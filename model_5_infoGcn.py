...
class infoGcn(nn.Module):
    ...
    def __init__(self,
        ...
        self.gcn = InfoGCN(in_channels, out_channels, spatial_kernel_size)
...
class C2F_TCN(nn.Module):
    ...
    def __init__(self, n_channels, n_classes, **kwargs):
        ...
        self.infoGcn_networks = nn.ModuleList((
            infoGcn(n_channels, 64, spatial_kernel_size),
            infoGcn(64, 128, spatial_kernel_size),
            infoGcn(128, 256, spatial_kernel_size),
            infoGcn(256, 256, spatial_kernel_size)
        ))
    ...
    def forward(self, x):
        ...
        # forwad
        for gcn in self.infoGcn_networks:
            x = gcn(x, self.A)
