...
def compute_average_precision_detection(
    ...
    #print('recall: ', recall_cumsum, recall_cumsum.shape)

    precision_cumsum = tp_cumsum / (tp_cumsum + fp_cumsum)
    #print('precision: ', precision_cumsum, precision_cumsum.shape)
...
det_eval = ANETdetection(
            'breakfast_split4.json', 'test'
        )
mAP, average_mAP = det_eval.evaluate('split4.json', verbose=True)
