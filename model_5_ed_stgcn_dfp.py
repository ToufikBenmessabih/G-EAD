...
class outconv(nn.Module):
    def __init__(self, in_ch, nbr_classes):
        ...
        self.gcn_embed = ConvGraphical(in_ch, nbr_classes, 3, 1)

        self.gcn_pool = ConvGraphical(in_ch, 13 , 3, 1)
        self.relu = nn.ReLU()
...
class TPPblock(nn.Module):
    ...
    def forward(self, x):
        ...
        x2_conv = self.conv(x_pool2)
        x3_conv = self.conv(x_pool3)
        x4_conv = self.conv(x_pool4)
