...
class SelfAttention(nn.Module):
    ...
    def forward(self, x):
        ...
        y = self.to_qk(y)          # (n, t, v, 132) [5, 230, 21, 132]   
        qk = y.chunk(2, dim=-1)    # q and k, each with shape (n, t, v, 132)
        q, k = map(lambda t: rearrange(t, 'b t v (h d) -> (b t) h v d', h=self.n_heads), qk) #q and k will have shapes (b*t, 2, v, 66)

        #print('Q:', q.shape)       # [1150, 2, 21, 66]
        #print('K:', k.shape)       # [1150, 2, 21, 66]
        # attention
