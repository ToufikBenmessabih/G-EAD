...
if args.dataset_name == "InHARD_13":
    ...
    config.chunk_size = 2
    config.max_frames_per_video = 993 #19330 #13005
    config.learning_rate = 1e-4
    config.weight_decay = 3e-3
...
config.features_file_name = config.base_dir + "/features/inhard-13/30fps_p" #"/features/inhard-13/30fps_p_light" #"/features/inhard-13/30fps_p/"
...
def get_ensemble_out(outp):
    ...
    ensemble_prob = F.softmax(outp, dim=1)
